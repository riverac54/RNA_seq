...
rsync -rptuvl arodriguez@dna.lavis.unam.mx:/mnt/Timina/bioinfoII/arodriguez/alignment/Musmusculus/fastqc_analisys .
```
...
![******Fig.1.****** La calidad de secuencia por base parece reducirse drasticamente de una puntuacion de calidad media de 28 en la primera base, a 7 en la ultima.](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/58961d1b-bd82-4bad-bd5e-3bfd96dd744a/Untitled.png)

### **Per tile sequence quality**

![************Fig.2.************ Las razones para ver advertencias o errores en este gráfico podrían ser problemas transitorios, como burbujas que atraviesan la celda de flujo, o podrían ser problemas más permanentes, como manchas en la celda de flujo o desechos dentro del carril de la celda de flujo.](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/6a22ceb1-da8c-4387-bf10-9e34f0e95831/Untitled.png)

### **Per sequence quality scores**

![**Fig.3.** Esta grafica permite ver si un subconjunto de sus secuencias tiene valores de calidad universalmente bajos. Se emite una advertencia si la calidad media observada con mayor frecuencia es inferior a 27, lo que equivale a una tasa de error del 0,2%.](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/0932d8c1-61ba-48e2-b677-b3b15e293abe/Untitled.png)
...
Nota: los archivos de alineamiento se encuentran en la carpeta `/mnt/Timina/bioinfoII/arodriguez/alignment/Musmusculus`
