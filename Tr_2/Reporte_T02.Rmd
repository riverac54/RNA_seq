...
Dado que son datos de un experimento de ChiP-seq, se espera que el porcentaje de lecturas que mapean correctamente a la referencia se bajo, de hehco, en este caso es de ~65%, lo cual se considera aceptable en este contexto. 
