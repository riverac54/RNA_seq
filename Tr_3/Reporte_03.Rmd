...
1. Gabrb1
Cobertura de $13$. Se cree que interviene en varios procesos, como la respuesta celular a la histamina, el transporte transmembrana de cloruro y la vía de señalización del ácido gamma-aminobutírico.

Predicted to enable GABA receptor binding activity; GABA-gated chloride ion channel activity; and transmitter-gated ion channel activity involved in regulation of postsynaptic membrane potential. 
