...
Hs_samples
Hs_files   <- file.path(".", Hs_samples$SRA,"abundance.h5") # Crear ruta a cada archivo abundance de cada SRA
...
## Análisis de términos GO (Manuel)
