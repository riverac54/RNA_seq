...
```{r}
#Bases de datos contenidas en ensembl Homo Sapiens
library(biomaRt)
listMarts(host="https://ensembl.org")


#Lista de especies contenidas
HS_ensembl <- useEnsembl(biomart="ENSEMBL_MART_ENSEMBL", host ="ensembl.org")
head(listDatasets(HS_ensembl))
...
```{r}
athaliana_database <- useMart(biomart = "p", host = "ensembl.org", dataset = "hsapiens_gene_ensembl")
