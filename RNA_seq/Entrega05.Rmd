...
#####ANALISIS DE VIVALDO. NO ESTABA EN bash
=======
...
=======
```{r eval=FALSE}
>>>>>>> 14e301c1c698d2f9f2285b5f0886d5b916135c56
# Comando
...
genes_to_test = rownames(data2[data2$log2FoldChange > 1.5 & data2$padj < 0.05, ])
...
```{r, eval= FALSE}
 # Generar la plot de los primeros 20 genes
plot(barplot(Go_results_UP, showCategory = 20, horiz=TRUE)) + barplot(Go_results_DOWN, showCategory = 15, horiz=TRUE) 
```
