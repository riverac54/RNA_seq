...
# tambien arroja uno con un 1 al final ?????????
cd ./gencode.v43.transcripts.fa.gz.1
...
do
  ...
  kallisto quant --index ../kallisto_quant3/Hm_ref.kidx --output-dir ../kallisto_quant3/${clean} --threads 12 ${file} ${file_2}
done
```
