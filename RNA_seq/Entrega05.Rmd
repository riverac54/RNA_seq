...
El análisis de calidad de genera usando los siguientes modulos y herramientas ****************

```{bash}

```

Para analizar la calidad de los datos crudos descargamos el reporte multiqc a nuestro ordenador con el siguiente comando:
